...
public class Game {
	...
	public static final String NAME = "Minicraft Community Edition"; // This is the name on the application window.
	public static final String BUILD = "1.0"; //mod version
	public static final Version VERSION = new Version("2.0.7-dev1");//mod base version
